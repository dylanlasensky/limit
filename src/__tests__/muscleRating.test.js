...
import { calculateMuscleRating, emptyRating, snapshotPayload } from '@/components/limit/muscleRating';

const MUSCLES = ['Chest', 'Shoulders', 'Back', 'Biceps', 'Triceps', 'Quads', 'Hamstrings', 'Glutes', 'Calves', 'Core'];

const benchPress = { name: 'Barbell Bench Press', primaryMuscle: 'Chest', secondaryMuscles: ['Triceps', 'Front delts'] };
