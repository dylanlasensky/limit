...
export default function MuscleRatingPanel({ rating, snapshots = [] }: MuscleRatingPanelProps) {
  ...
  return (
    <section className="limit-hero rounded-[2rem] p-5 sm:p-6 lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:items-start lg:gap-x-6">
      ...
      <div className="min-w-0">
        <div className="relative z-10 mt-5 flex rounded-xl bg-background/60 p-1 lg:mt-0">
          <button
